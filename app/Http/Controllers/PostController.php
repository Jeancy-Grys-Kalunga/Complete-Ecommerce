...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Erreur survenue lors de l\'enregistrement veuillez réessayer plus tard !!');
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($status){
            request()->session()->flash('success','Article modifié avec succès ');
        }
        else{
            request()->session()->flash('error','Erreur survenue lors de la modification de l\'article');
        }
        return redirect()->route('post.index');
    }
    ...
    public function destroy($id)
    {
        ...
        if($status){
            ...
            request()->session()->flash('error','Erreur survenue lors de la suppresionde l\'article !!!');
        }
        return redirect()->route('post.index');
    }
}
