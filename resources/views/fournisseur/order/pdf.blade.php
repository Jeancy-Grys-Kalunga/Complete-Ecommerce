...
<style type="text/css">
  ...
  <div class="invoice-header">
    ...
    <div class="float-right site-address">
      <h4>{{env('APP_NAME')}}</h4>
      <p>{{env('APP_ADDRESS')}}</p>
      <p>N° Téléphone: <a href="tel:{{env('APP_PHONE')}}">{{env('APP_PHONE')}}</a></p>
      <p>E-mail: <a href="mailto:{{env('APP_EMAIL')}}">{{env('APP_EMAIL')}}</a></p>
    </div>
      ...
      <h6>Facture de</h6>
       ...
       <div class="address">
        ...
        <p>
         ...
         <p><strong>N° Tél:</strong> {{ $order->phone }}</p>
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endphp
        <tr>
          ...
          <td><span>{{number_format($cart->price,2)}} FC</span></td>
        </tr>
      @endforeach
      </tbody>
      <tfoot>
        <tr>
          ...
          <th scope="col"> <span>{{number_format($order->sub_total,2)}} FC</span></th>
        </tr>
