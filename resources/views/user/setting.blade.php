...
<div class="card">
    <h5 class="card-header">Editer Paramètres</h5>
    <div class="card-body">
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">N° Téléphone <span class="text-danger">*</span></label>
...
<script>
    ...
    $('#summary').summernote({
      placeholder: "Ecrire une courte déscription....",
        tabsize: 2,
        height: 150
    });
    });
    ...
    $(document).ready(function() {
      $('#description').summernote({
        placeholder: "Détailler votre description.....",
          tabsize: 2,
          height: 150
      });
    });
