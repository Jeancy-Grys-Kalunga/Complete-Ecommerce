                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            <td align="right">
                                                                <table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                                                    <tr>
                                                                        <td class="img" width="32" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                            <a href="#" target="_blank"><img src="../Public/img/Email/free_ico_facebook.jpg" width="14" height="13" editable="true" border="0" alt="" /></a>
                                                                        </td>
                                                                        <td class="img" width="14" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                            <a href="#" target="_blank"><img src="../Public/img/Email/free_ico_instagram.jpg" width="14" height="13" editable="true" border="0" alt="" /></a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td bgcolor="#ffffff" class="p30-15 img-center" style="padding: 30px; border-radius: 20px 20px 0px 0px; font-size:0pt; line-height:0pt; text-align:center;">
                                        <a href="#" target="_blank"><img src="../Public/img/logo/LOGO.jpg" height="50" width="100" alt="" /></a>
                                    </td>
                                </tr>
                                <!-- END Logo -->
                                <!-- Nav -->
                            ...
                            <repeater>
                                ...
                                <layout label="Section 1">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ebebeb">
                                        <tr>
                                            <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="../Public/img/images/slide-4.jpg" width="650" height="358" editable="true" border="0" alt="" /></td>
                                        </tr>
                                        <tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td class="h5-center" style="color:#a1a1a1; font-family:'Raleway', Arial,sans-serif; font-size:16px; line-height:22px; text-align:center; padding-bottom:5px;">
                                                            <multiline>MNG Delevery</multiline>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="h2-center" style="color:#000000; font-family:'Playfair Display', Times, 'Times New Roman', serif; font-size:32px; line-height:36px; text-align:center; padding-bottom:20px;">
                                                            <multiline>Bienvenue a notre NewsLetter  !</multiline>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-center" style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:center; padding-bottom:22px;">
                                                            <multiline>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris
                                                                nisi ut aliquip ex ea commodo conse.</multiline>
                                                        </td>
                                                    </tr>
                                ...
                                <layout label="Section 2">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#dde8fd">
                                                    <tr>
                                                        <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="../Public/img/Email/free_white_blue.jpg" width="650" height="162" editable="true" border="0" alt="" /></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="p0-15" style="padding: 0px 30px;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="h2-center" style="color:#000000; font-family:'Playfair Display', Times, 'Times New Roman', serif; font-size:32px; line-height:36px; text-align:center; padding-bottom:20px;">
                                                                        <multiline>Upcoming Events</multiline>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                        ...
                                        <tr>
                                            <td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="../Public/img/Email/free_blue_white.jpg" width="650" height="160" editable="true" border="0" alt="" /></td>
                                        </tr>
                                    </table>
                                </layout>
                                <!-- END Section 2 -->
                                                        ...
                                                        <table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                                            <tr>
                                                                <td class="img" width="40" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="#" target="_blank"><img src="../Public/img/Email/ico4_facebook.png" width="26" height="26" editable="true" border="0" alt="" /></a>
                                                                </td>

                                                                <td class="img" width="40" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="#" target="_blank"><img src="../Public/img/Email/ico4_instagram.png" width="26" height="26" editable="true" border="0" alt="" /></a>
                                                                </td>

                                                                <td class="img" width="40" style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                    <a href="#" target="_blank"><img src="../Public/img/Email/ico4_linkedin.png" width="26" height="26" editable="true" border="0" alt="" /></a>
                                                                </td>
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tr>
                                                                            <td class="text-footer" style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:13px; line-height:22px; text-align:left;">
                                                                                <multiline>
                                                                                    <strong>Elotek Congo Sarl</strong><br />
                                                                                </multiline>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-footer" style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:13px; line-height:22px; text-align:left;">
                                                                                <multiline>
                                                                                    ...
                                                                                    <a href="#" target="_blank" class="link-grey" style="color:#5d5c5c; text-decoration:none;"><span class="link-grey" style="color:#5d5c5c; text-decoration:none;">Livraison à domicile</span></a><br
                                                                                    />
                                                                                    <a href="#" target="_blank" class="link-grey" style="color:#5d5c5c; text-decoration:none;"><span class="link-grey" style="color:#5d5c5c; text-decoration:none;">Vente et paiement en ligne</span></a><br
                                                                                    />
                                                                                    <a href="#" target="_blank" class="link-grey" style="color:#5d5c5c; text-decoration:none;"><span class="link-grey" style="color:#5d5c5c; text-decoration:none;">Logistique & Transport</span></a><br
                                                                                    />
                                                                                </multiline>
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-footer" style="color:#5d5c5c; font-family:'Raleway', Arial,sans-serif; font-size:13px; line-height:22px; text-align:left;">
                                                                                <multiline>
                                                                                    ...
                                                                                    <a href="#" target="_blank" class="link-grey" style="color:#5d5c5c; text-decoration:none;"><span class="link-grey" style="color:#5d5c5c; text-decoration:none;">Adresse :108, Lubumbashi, Haut-Katanga/ DRC</span></a>                                                                                    <br />
                                                                                    <a href="#" target="_blank" class="link-grey" style="color:#5d5c5c; text-decoration:none;"><span class="link-grey" style="color:#5d5c5c; text-decoration:none;">Email : contact@mngdelevery.com, infoelco1@gmail.com</span></a>                                                                                    <br />
                                                                                    <a href="#" target="_blank" class="link-grey" style="color:#5d5c5c; text-decoration:none;"><span class="link-grey" style="color:#5d5c5c; text-decoration:none;">Contact :+243 85 163 86 66
                                                                                            +243 85 163 86 39</span></a> <br />
                                                                                </multiline>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td class="text-footer2 p30-15" style="padding: 30px 15px 50px 15px; color:#a9b6e0; font-family:'Raleway', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;">
                                            <multiline>Vous souhaitez modifier la façon dont vous recevez ces e-mails</multiline>

                                            <unsubscribe class="link-white" style="color:#ffffff; text-decoration:none;">se désinscrire</unsubscribe>
                                        </td>
                                    </tr>
                                </table>
                                <!-- END Footer -->
