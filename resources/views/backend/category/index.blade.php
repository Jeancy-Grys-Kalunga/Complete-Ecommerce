...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Ajouter une nouvelle catégorie</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Catégorie non trouvée !! Veuillez en créer une</h6>
        @endif
      </div>
    </div>
</div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title: "Etes-vous sûr?",
                    text: "Voulez-vous vraiment suppriemt cette catégorie !",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
