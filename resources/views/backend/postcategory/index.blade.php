...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste Catégorie Post</h6>
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Ajouter Catégorie Post</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Aucune catégorie de post trouvé!! Veuillez en créer une nouvelle </h6>
        @endif
      </div>
    </div>
</div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title: "Etês-vous sûr?",
                    text: "Voulez-vous vraiment supprimer cette catégorie Post ?",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                       form.submit();
                        ...
                        swal("Catégorie Post supprimée avec succès !");
                    }
                });
          })
      })
