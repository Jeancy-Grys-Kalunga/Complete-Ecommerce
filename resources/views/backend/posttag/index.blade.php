...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste Post Tag </h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Aucun Post Tag trouvé !!! Veuillez en créer un nouveau post tag</h6>
        @endif
      </div>
    </div>
</div>
        ...
        $.ajaxSetup({
          ...
          $('.dltBtn').click(function(e){
            var form=$(this).closest('form');
              ...
              swal({
                    title: "Etês-vous sûr ?",
                    text: "Voulez-vous vraiment supprimer ce Post Tag ? ",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                       form.submit();
                        ...
                        swal("Post Tag supprimé avec succès !");
                    }
                });
          })
      })
