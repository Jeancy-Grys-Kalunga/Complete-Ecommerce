...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('post.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Ajouter Post</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Aucun n'article trouvé !! Veuillez créer un nouveau article</h6>
        @endif
      </div>
    </div>
</div>
                ...
                .then((willDelete) => {
                    if (willDelete) {
                       form.submit();
                        ...
                        swal("Post supprimé avec succès !!!!");
                    }
                });
          })
      })
