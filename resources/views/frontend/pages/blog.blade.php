                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                ...
                                <img src="{{$post->photo}}" alt="{{$post->photo}}">
                                    <div class="content">
                                        ...
                                        <a href="{{route('blog.detail',$post->slug)}}" class="more-btn">Lire plus</a>
                                    </div>
                                </div>
                                <!-- End Single Blog  -->
                            </div>
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Inscrivez-vous & Pour n'est rien manqué <br> </h4>
                                <form method="POST" action="{{route('subscribe')}}" class="form-inner">
                                    @csrf
                                    <input type="email" name="email" placeholder="Enter your email">
                                    <button type="submit" class="btn " style="width: 100%">Inscription</button>
                                </form>
                            </div>
                        </div>
                        <!--/ End Single Widget -->
