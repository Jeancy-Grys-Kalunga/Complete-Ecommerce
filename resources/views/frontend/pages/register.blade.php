...
@section('title','E-SHOP | Inscription ')
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-12">
                    <div class="login-form">
                        <h2>S'inscrire</h2>
                        <p>Prière de vous inscrire pour pouvoir commander plus rapidement</p>
                        <!-- Form -->
                        <form class="form" method="post" action="{{route('register.submit')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Veuillez choisir le rôle que vous aller effectuer<span>*</span></label>
                                        <select name="role" class="form-control">
                                            <option value="">Seléctionnner</option>
