							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount" data-title="Total"><span>{{$wishlist['amount']}} FC</span></td>
							...
							@else
								<tr>
									<td class="text-center">
										Vous n'avez pas encore des produits enregistés comme favoris. <a href="{{route('product-grids')}}" style="color:blue;">Continuer le shopping</a>
