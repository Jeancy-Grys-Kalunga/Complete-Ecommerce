...
@section('title','Blog Détail')
@section('page','Détail du Post')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>De {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Commentaires ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">Poster votre commentaire</span><span class="comment_btn reply" style="display: none;">Répondre</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget recent-post">
                            <h3 class="title">Récente publication</h3>
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Inscrivez-vous & pour n'est rien manqué de nos nouvelles <br></h4>
                                <form action="{{route('subscribe')}}" method="POST">
                                    @csrf
                                    <div class="form-inner">
                                        <input type="email" name="email" placeholder="Enter your email">
                                        <button type="submit" class="btn mt-2">Inscription</button>
                                    </div>
                                </form>
                            </div>
                        </div>
