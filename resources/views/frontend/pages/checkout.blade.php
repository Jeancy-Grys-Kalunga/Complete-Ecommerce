                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            ...
                            <p>Prière de vous inscrire pour pouvoir payer plus rapidement</p>
                            <!-- Form -->
                            <div class="row">
                        ...
                        <div class="order-details">
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <ul>
                                        ...
                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">Vous sauvegardez<span>{{ number_format(session('coupon')['value'], 2) }} FC</span></li>
                                        @endif
                                        @php
                                        ...
                                        @if (session('coupon'))
                                            <li class="last" id="order_total_price">
                                                Total<span>{{ number_format($total_amount, 2) }} FC</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                Total<span>{{ number_format($total_amount, 2) }} FC</span></li>
                                        @endif
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        ...
                                        <form-group>
                                            ...
                                            <input name="payment_method" type="radio" value="mobile"> <label>
                                                Mobile Money</label>
                                        </form-group>
                            ...
                            <div class="single-widget get-button">
                                <div class="content">
                                    ...
                                    <div class="button">
                                        <button type="submit" class="btn">Passer Commande</button>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('.shipping select[name=shipping]').change(function() {
                ...
                // alert(coupon);
                $('#order_total_price span').text((subtotal + cost - coupon).toFixed(2) + ' FC');
            });
