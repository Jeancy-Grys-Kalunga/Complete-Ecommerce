...
@section('page','Grille de produits')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">{{number_format($product->price,2)}} FC</del>   FC{{number_format($org,2)}}  </p>
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                        ...
                        <div class="row">
                            ...
                            @if(count($products)>0)
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="button-head">
                                                    <div class="product-action">
                                                        <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i><span>Vente Rapide</span></a>
                                                        <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Ajouter au favoris</span></a>
                                                    </div>
                                ...
                                @endforeach
                            @else
                                    <h4 class="text-warning" style="margin:100px auto;">Il n'y a pas de produits pour le moment.</h4>
                            @endif
