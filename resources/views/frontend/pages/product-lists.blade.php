...
@section('page','Liste des produits')
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            ...
                                            <div class="content">
                                                ...
                                                @endphp
                                                <p class="price"><del class="text-muted">{{number_format($product->price,2)}} FC</del>  {{number_format($org,2)}}FC  </p>
                                            </div>
                                        </div>
                                        <!-- End Single Post -->
                                    @endforeach
											...
											<div class="quickview-content">
												...
												<div class="quickview-ratting-review">
													<div class="quickview-ratting-wrap">
														...
														<a href="#"> ({{$rate_count}} avis des clients)</a>
													</div>
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">{{number_format($product->price,2)}} FC</del></small>    FC{{number_format($after_discount,2)}}  </h3>
